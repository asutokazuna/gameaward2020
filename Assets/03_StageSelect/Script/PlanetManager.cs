...
public class PlanetManager : MonoBehaviour
{
    ...
    public GameObject _planetObject;            //回転の中心となるプレイヤー格納用
    ...
    private void SetPlanet()
    {
        ...
        myTransform.position = _setPlanetPos;  // 座標を設定
        myTransform.LookAt(_setPlanetRot);  // 向きを設定
    }
    /**
    ...
    private void rotatePlanet()
    {
        ...
        _planetObject.transform.RotateAround(_planetObject.transform.position, Vector3.up, angle.x);
        _planetObject.transform.RotateAround(_planetObject.transform.position, transform.right, angle.y);
    }
}
